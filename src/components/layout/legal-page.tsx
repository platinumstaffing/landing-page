  ...
  return (
    <>
      ...
      <Container className="max-w-3xl py-14 sm:py-16">
        {draft ? (
          <div className="mb-10 flex gap-3 rounded-xl border border-primary/30 bg-accent p-4 sm:p-5">
            <Info
        ...
        <div className="max-w-none text-[0.95rem] leading-relaxed text-muted-foreground [&_a]:font-medium [&_a]:text-primary [&_a]:underline [&_a]:underline-offset-4 [&_h2]:mt-10 [&_h2]:font-heading [&_h2]:text-xl [&_h2]:font-bold [&_h2]:text-foreground [&_h3]:mt-6 [&_h3]:font-heading [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-foreground [&_li]:mt-1.5 [&_p]:mt-3 [&_strong]:font-semibold [&_strong]:text-foreground [&_ul]:mt-3 [&_ul]:list-disc [&_ul]:pl-5">
          {children}
        </div>
      </Container>
    </>
